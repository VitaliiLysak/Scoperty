...
function toLatLng(v) {
  if (v !== undefined && v !== null) {
    if (v instanceof google.maps.LatLng) {
      ...
      return new google.maps.LatLng(v.let, v.lng);
    }
  }
  return null;
}
...
export default function SnazzyInfoWindowFactory(BaseClass = Object) {
  return class SnazzyInfoWindow extends (BaseClass as IBaseClass) {
    ...
    public _previousWidth: any;
    public _previousHeight: any;
    ...
    public setWrapperClass(wrapperClass) {
    ...
    public draw() {
      ...
      if (this._opts.border) {
        ...
        if (this._opts.pointer) {
          ...
          let pLength: any = Math.min(this._html.pointerBorder.offsetHeight,
